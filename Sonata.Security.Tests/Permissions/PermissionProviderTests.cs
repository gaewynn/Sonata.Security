...
namespace Sonata.Security.Tests.Permissions
{
	...
	public class PermissionProviderTests
	{
		...
		public class SolveTests : PermissionProviderTests
		{
			...
			{
				var solutions = Fixture.Provider.Solve("collab", int.MaxValue, "Collab").ToList();
			...
			{
				var solutions = Fixture.Provider.Solve("collab", int.MaxValue, "Collab", "\"ge\"").ToList();
			...
			{
				var solutions = Fixture.Provider.Solve("responsableActivite", int.MaxValue, "\"afi\"", "Activite").ToList();
